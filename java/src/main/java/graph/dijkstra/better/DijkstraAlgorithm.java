...
public class DijkstraAlgorithm {
  ...
  public static int dijkstra(Graph graph, String startVertex, String stopVertex) {
    ...
    for (String minWeightVertex = getMinWeightVertex(vertexWeight, handledVertex);
        minWeightVertex != null;
        minWeightVertex = getMinWeightVertex(vertexWeight, handledVertex)) {
  ...
  private static String getMinWeightVertex(Map<String, Integer> vertexWeight,
      Set<String> handledVertex) {
